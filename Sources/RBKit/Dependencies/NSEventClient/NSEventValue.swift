...
extension NSEventValue {
  public init(nsEvent: NSEvent) {
    ...
    trackingNumber = nsEvent.trackingNumber // NSInternalInconsistencyException
    userData = nsEvent.userData // NSInternalInconsistencyException
    subtype = nsEvent.subtype // NSInternalInconsistencyException
    data1 = nsEvent.data1 // NSInternalInconsistencyException
    data2 = nsEvent.data2 // NSInternalInconsistencyException
