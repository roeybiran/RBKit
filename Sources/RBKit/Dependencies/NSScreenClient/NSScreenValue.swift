...
public struct NSScreenValue {
  ...
  public init(
    ...
    self.maximumPotentialExtendedDynamicRangeColorComponentValue =
      maximumPotentialExtendedDynamicRangeColorComponentValue
    self.maximumExtendedDynamicRangeColorComponentValue =
      maximumExtendedDynamicRangeColorComponentValue
    self.maximumReferenceExtendedDynamicRangeColorComponentValue =
