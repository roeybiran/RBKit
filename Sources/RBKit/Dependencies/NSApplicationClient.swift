...
public struct NSApplicationClient: Sendable {
  ...
  @DependencyEndpoint(method: "yieldActivation")
  public var yieldActivationToApplicationWithBundleIdentifier: @Sendable @MainActor (_ toApplicationWithBundleIdentifier: String) -> Void

  /// Managing Windows, Panels, and Menus
  public var runModal: @MainActor @Sendable (_ window: NSWindow) -> NSApplication.ModalResponse = { _ in .OK }
  public var stopModal: @MainActor @Sendable () -> Void

  //
  public var activationPolicy: @MainActor @Sendable () -> NSApplication.ActivationPolicy = { .prohibited }
  public var setActivationPolicy: @MainActor @Sendable (_ activationPolicy: NSApplication.ActivationPolicy) -> Bool = { _ in false }
}
