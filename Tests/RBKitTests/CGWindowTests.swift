...
struct CGWindowValueTests {
  ...
  @Test
  func `init, with complete dictionary, should create value`() {
  ...
  @Test
  func `init, with missing window number, should return nil`() {
  ...
  @Test
  func `init, with missing store type, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing layer, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing bounds, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with bounds missing X value, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with bounds missing Y value, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with bounds missing width, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with bounds missing height, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing sharing state, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing alpha, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing owner pid, should return nil`() {
    var dictionary = makeWindowDictionary()
  ...
  @Test
  func `init, with missing memory usage, should return nil`() {
    var dictionary = makeWindowDictionary()
